...
<style scoped>
  ...
  .extend_handle:before{content:""; display: block; width:100%;height: 100%;box-sizing: border-box; border:3px solid;border-color:#ccc #ccc transparent transparent;
  ...
  .extend::after{content: "";position: absolute;left:50%;bottom:15px;height:15px;border-left:3px solid #ccc;transform: translate3d(-2px,0,0)}
  .childLevel::before{content: "";position: absolute;left:50%;bottom:100%;height:15px;border-left:3px solid #ccc;transform: translate3d(-2px,0,0)}
  .childLevel::after{content: "";position: absolute;left:0;right:0;top:-15px;border-top:3px solid #ccc;}
  .childLevel:first-child:before, .childLevel:last-child:before{display: none;}
  .childLevel:first-child:after{left:50%;height:13px; border:3px solid;border-color:#ccc transparent transparent #ccc;border-radius: 0px 0 0 0;transform: translate3d(3px,0,0)}
  .childLevel:last-child:after{right:50%;height:13px; border:3px solid;border-color:#ccc #ccc transparent transparent;border-radius: 0 0px 0 0;transform: translate3d(-3px,0,0)}
  .childLevel:first-child.childLevel:last-child::after{left:auto;border-radius: 0;border-color:transparent #ccc transparent transparent;transform: translate3d(1px,-2px,0)}

  .node{position: relative; display: inline-block;width: 6em;box-sizing: border-box; text-align: center;}
  .node .person{position: relative; display: inline-block;z-index: 2;width:6em; overflow: hidden;}
  .node .person .avat{display: block;width:4em;height: 4em;margin:auto;overflow:hidden; background:transparent;border:2px solid #ccc;box-sizing: border-box;}
  .node .person .avat img{width:100%;height: 100%;}
  .node .person .name{height:2em;line-height: 2em;overflow: hidden;width:100%;}
  .node.hasMate::after{content: "";position: absolute;left:2em;right:2em;top:2em;border-top:3px solid #ccc;z-index: 1;}
